...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    */
    ...
    // Création de la requête SQL permettant de récupérer les informations de l'utilisateur en base de données
    // à partir du login et password saisis par l'utilisateur
    $query = "SELECT * FROM t_user where useLogin = :useLogin AND usePassword = :userPassword";

    // Exécution de la requête. A noter l'utilisation de la méthode ->prepare()
    // et le bind des valeurs saisies par l'utilisateur
